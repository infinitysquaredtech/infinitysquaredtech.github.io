                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center">
                                    <i className="fas fa-envelope text-white text-xl mr-4"></i>
                                    <span className="text-gray-300">hello@infinitysquared.tech</span>
                                </div>
                                <div className="flex items-center">
                                    <i className="fas fa-phone text-white text-xl mr-4"></i>
                                    <span className="text-gray-300">+1 (555) 123-4567</span>
                                </div>
                                <div className="flex items-center">
                                    <i className="fas fa-map-marker-alt text-white text-xl mr-4"></i>
                                    <span className="text-gray-300">San Francisco, CA</span>
                                </div>
                            </div>
                        </div>

                        <form onSubmit={handleSubmit} className="bg-gray-900 rounded-2xl p-8 shadow-lg border border-gray-800">
