function PortfolioScroller({ projects, title }) {
    try {
        ...
        return (
            <div id='projects' data-name="portfolio-scroller" data-file="lib/components/PortfolioScroller.js" className="mb-12 md:mb-16 py-20">
                ...
                <div className="relative">
                    ...
                    <button 
                        ...
                        className="absolute left-0 md:-left-4 top-1/2 transform -translate-y-1/2 bg-white text-black w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center shadow-lg cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-100 transition-colors z-10"
                    >
                    ...
                    <button 
                        ...
                        className="absolute right-0 md:-right-4 top-1/2 transform -translate-y-1/2 bg-white text-black w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center shadow-lg cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-100 transition-colors z-10"
                    >
                ...
                {showModal && selectedProject && (
                    <div className="fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-2 md:p-4">
