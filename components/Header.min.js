                ...
                <nav className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center logo-container">
                            <img 
                                src="https://infinitysquaredtech.com/asset/logos/infinity_logo.webp" 
                        ...
                        <div className="hidden md:flex space-x-8">
                            ...
                            <button onClick={() => scrollToSection('clients')} className="text-gray-700 hover:text-black transition-colors font-medium">Clients</button>
                    ...
                    {isMenuOpen && (
                        <div className="md:hidden mt-4 pb-4 border-t border-gray-200 pt-4">
                            <div className="flex flex-col space-y-3">
                                ...
                                <button onClick={() => scrollToSection('clients')} className="text-gray-700 hover:text-black py-2 text-left">Clients</button>
